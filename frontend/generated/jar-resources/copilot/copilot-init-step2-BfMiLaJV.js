import { u as y, v as C, w as K, b as g, j as r, C as X, x as c, y as Le, z as S, A as Z, B as _, O as pe, D as A, F as h, G as l, H as he, I as qe, J as Xe, K as ee, L as be, E as u, N as Ye, k as ue, l as We, P as Ge, Q as Ke, V as Ze, R as ze, S as k, T as Qe, U as F, M as q, W as et, X as Y, Y as tt, Z as we, _ as Me, $ as it, a0 as nt, a1 as ot, a2 as st, a3 as at, a4 as rt, a5 as lt, a6 as dt, a7 as ct, a8 as pt, a9 as ht, aa as _e, ab as ut, ac as ge, ad as gt } from "./copilot-A31R8Nih.js";
import { n as E, r as v } from "./state-nFB4Jps6.js";
import { e as O, m as Q } from "./overlay-monkeypatch-xAh6pLIt.js";
import { i as d } from "./icons-BubLMvbT.js";
import { e as z, c as mt } from "./early-project-state-D-LivTOJ.js";
const ft = 1, ye = 36, vt = 18;
function bt(e, t) {
  if (e.length === 0)
    return;
  const i = wt(e, t);
...
function wt(e, t) {
  ...
  return e.map((s) => {
    const a = s.panelInfo;
    return a && !a.expanded ? ye : (t.offsetHeight - (t.position === "bottom" ? vt : 0) - o * ye - i * ft) / n;
  });
}
var yt = Object.defineProperty, xt = Object.getOwnPropertyDescriptor, T = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? xt(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && yt(t, i, o), o;
};
const te = "data-drag-initial-index", B = "data-drag-final-index";
let R = class extends C {
  constructor() {
    super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.panelCountChanged = K(() => {
      this.refreshSplit();
      ...
      if (!Le(this.getBoundingClientRect(), t, i)) {
      ...
      this.getAllPanels().sort((t, i) => {
        ...
        if (t.setAttribute(B, `${i}`), t.panelTag !== this.draggingSectionPanel?.panelTag) {
          const n = Number.parseInt(t.getAttribute(te), 10);
  ...
  cleanUpDragging() {
    this.draggingSectionPanel && (r.setSectionPanelDragging(!1), this.draggingSectionPanel.style.zIndex = "", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((e) => {
      e.style.removeProperty("transform"), e.removeAttribute(B), e.removeAttribute(te);
  ...
  refreshSplit() {
    bt(this.getAllPanelsOrdered(), this);
  }
};
T([
...
var Pt = Object.defineProperty, It = Object.getOwnPropertyDescriptor, Oe = (e, t, i, n) => {
...
class At {
  ...
  dragging(t, i) {
    const n = i.clientX, o = i.clientY, s = n - this.offsetX, a = n - this.offsetX + t.getBoundingClientRect().width, p = o - this.offsetY, f = o - this.offsetY + t.getBoundingClientRect().height;
    return this.adjust(t, s, p, a, f);
  }
  adjust(t, i, n, o, s) {
    let a, p, f, b;
    const P = document.documentElement.getBoundingClientRect().width, N = document.documentElement.getBoundingClientRect().height;
    return (o + i) / 2 < P / 2 ? (t.style.setProperty("--left", `${i}px`), t.style.setProperty("--right", ""), b = void 0, a = Math.max(0, i)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${P - o}px`), a = void 0, b = Math.max(0, P - o)), (n + s) / 2 < N / 2 ? (t.style.setProperty("--top", `${n}px`), t.style.setProperty("--bottom", ""), f = void 0, p = Math.max(0, n)) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${N - s}px`), p = void 0, f = Math.max(0, N - s)), {
      left: a,
      right: b,
      top: p,
      bottom: f
...
const I = new At();
var $t = Object.defineProperty, Ct = Object.getOwnPropertyDescriptor, U = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? Ct(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && $t(t, i, o), o;
};
const xe = "https://github.com/JetBrains/JetBrainsRuntime/releases";
function kt(e, t) {
  if (!t)
    return !0;
  const [i, n, o] = t.split(".").map((f) => parseInt(f)), [s, a, p] = e.split(".").map((f) => parseInt(f));
  if (i < s)
    return !0;
  if (i === s) {
    if (n < a)
...
let x = class extends C {
  constructor() {
    super(), this.javaPluginSectionOpened = !1, this.hotswapSectionOpened = !1, this.hotswapTab = "hotswapagent", this.downloadStatusMessages = [], this.downloadProgress = 0, this.onDownloadStatusUpdate = this.downloadStatusUpdate.bind(this), this.reaction(
      ...
      () => {
        r.idePluginState && (!r.idePluginState.ide || !r.idePluginState.active ? this.javaPluginSectionOpened = !0 : (!(/* @__PURE__ */ new Set(["vscode", "intellij"])).has(r.idePluginState.ide) || !r.idePluginState.active) && (this.javaPluginSectionOpened = !1)), r.jdkInfo && ee() !== "success" && (this.hotswapSectionOpened = !0);
      },
      { fireImmediately: !0 }
    );
  }
  ...
  render() {
    ...
    return l`
      ...
      <div part="footer">
        <vaadin-button
          id="close"
          @click="${() => c.updatePanel(me.tag, { floating: !1 })}"
          >Close
        </vaadin-button>
      </div>
    `;
  ...
  renderPluginIsNotInstalledContent(e) {
    ...
    return e.intellij ? (t = Ke, i = "Install from JetBrains Marketplace") : e.vscode && (t = Ze, i = "Install from VSCode Marketplace"), l`
      <div>
  ...
  renderHotswapAgentJdkSection(e) {
    const t = r.jdkInfo?.extendedClassDefCapable, i = this.downloadStatusMessages?.[this.downloadStatusMessages.length - 1] === Pe;
    return l`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          <summary>
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && kt("1.3.0", r.idePluginState?.version) ? l` <li>Upgrade to the latest IntelliJ plugin</li>` : u}
              ...
              <li>
                ${e.intellij || e.vscode ? l`If there is a problem, you can manually
                      <a target="_blank" href="${xe}">download JetBrains Runtime JDK</a> and set up
                      your debug configuration to use it.` : l`<a target="_blank" href="${xe}">Download JetBrains Runtime JDK</a> and set up
  ...
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = !0, e.preventDefault(), this.downloadStatusMessages = [], ue(`${Ge}set-up-vs-code-hotswap`, {}, (t) => {
      t.data.error ? (We("Error downloading JetBrains runtime", t.data.error), this.downloadStatusMessages = [...this.downloadStatusMessages, "Download failed"]) : this.downloadStatusMessages = [...this.downloadStatusMessages, Pe];
    });
  }
...
window.Vaadin.copilot.plugins.push(St);
c.addPanel(me);
var Rt = Object.getOwnPropertyDescriptor, Dt = (e, t, i, n) => {
...
let Ie = class extends C {
  ...
  render() {
    const e = ze(), t = e.status === "warning" || e.status === "error";
    return l`
...
var Et = Object.getOwnPropertyDescriptor, Lt = (e, t, i, n) => {
...
let Ae = class extends C {
  ...
  renderDot() {
    return r.userInfo?.validLicense ? u : k.active || k.expired ? l`<div class="dot warning"></div>` : u;
  }
};
Ae = Lt([
...
function m(e) {
  return Te("vaadin-menu-bar-item", e);
}
function ie(e) {
  return Te("vaadin-context-menu-item", e);
}
function Te(e, t) {
  ...
  if (t.style && (i.className = t.style), t.icon)
    if (typeof t.icon == "string") {
      ...
      i.append($e(t.icon.strings[0]));
  if (t.label) {
    const n = document.createElement("span");
    n.className = "label", n.innerHTML = t.label, i.append(n);
  } else if (t.component) {
    const n = Qe(t.component) ? t.component : document.createElement(t.component);
    i.append(n);
  }
  if (t.hint) {
    const n = document.createElement("span");
...
function Ue(e) {
  return ue("copilot-switch-user", { username: e }, (t) => t.data.error ? (F({ type: q.ERROR, message: "Unable to switch user", details: t.data.error.message }), !1) : !0);
}
var zt = Object.defineProperty, Mt = Object.getOwnPropertyDescriptor, H = (e, t, i, n) => {
...
function Ot() {
  ...
  return e.label = "Username to Switch To", e.style.width = "100%", e.autocomplete = "off", e.addEventListener("click", async (t) => {
    ...
    if (t.stopPropagation(), t.key === "Enter") {
      const i = e.value;
      await Ue(i) && (h.addRecentSwitchedUsername(i), window.location.reload());
    }
  }), e;
}
...
let J = class extends C {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: i } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(i - this.initialMouseDownPosition.y) > _t;
      }
      ...
      return i ? Array.from(i).some((o) => {
        ...
        if (!s)
          return !1;
        const a = s.getBoundingClientRect(), p = n.getBoundingClientRect(), f = Math.min(a.x, p.x), b = Math.min(a.y, p.y), P = Math.max(a.width, p.width), N = a.height + p.height;
        return Le(new DOMRect(f, b, P, N), e.clientX, e.clientY);
      }) : !1;
  ...
  generateItems() {
    ...
    if (z.springSecurityEnabled) {
      const o = h.getRecentSwitchedUsernames();
      i.push(
        ...o.map((s) => ({
          component: m({ component: Tt(s) }),
          action: async () => {
            await Ue(s) && window.location.reload();
          }
        }))
    ...
    const n = [
      {
        ...
        children: [
          ...
          { visible: e, component: "hr" },
          {
            visible: z.springSecurityEnabled,
            component: m({
              icon: d.user,
            ...
            children: [
              {
                ...
                keepOpen: !0,
                action: (o) => {
                  h.setActivationShortcut(!h.isActivationShortcut()), ne(o, h.isActivationShortcut());
                }
              },
              {
                component: m({
                ...
                keepOpen: !0,
                action: (o) => {
                  h.setActivationAnimation(!h.isActivationAnimation()), ne(o, h.isActivationAnimation());
                }
              },
              {
                component: m({
                ...
                action: (o) => {
                  ...
                  a === "ask" ? s = "yes" : a === "no" ? s = "ask" : s = "no", h.setAIUsageAllowed(s), Ht(o);
                }
              },
              {
                component: m({
                ...
                keepOpen: !0,
                action: (o) => {
                  h.setSendErrorReportsAllowed(!h.isSendErrorReportsAllowed()), ne(o, h.isSendErrorReportsAllowed());
                }
              },
              { component: "hr" },
              {
          ...
          },
          {
            component: m({
              icon: d.vaadinLogo,
              label: "Copilot",
              hint: h.isActivationShortcut() ? Y.toggleCopilot : void 0,
  ...
  handleMenuItemClick(e) {
    e.action && (e.action(e), e.keepOpen && Ut());
  }
  firstUpdated() {
    this.setMenuBarOnClick(), Q(this.shadowRoot);
  }
};
H([
  O("vaadin-menu-bar")
...
var jt = Object.defineProperty, Nt = Object.getOwnPropertyDescriptor, j = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? Nt(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && jt(t, i, o), o;
};
const w = "resize-dir", oe = "floating-resizing-active";
let D = class extends C {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      let p = "";
      i < a ? o < a ? (p = "nw-resize", this.setAttribute(w, "top left")) : s < a ? (p = "sw-resize", this.setAttribute(w, "bottom left")) : (p = "col-resize", this.setAttribute(w, "left")) : n < a ? o < a ? (p = "ne-resize", this.setAttribute(w, "top right")) : s < a ? (p = "se-resize", this.setAttribute(w, "bottom right")) : (p = "col-resize", this.setAttribute(w, "right")) : s < a ? (p = "row-resize", this.setAttribute(w, "bottom")) : o < a && (p = "row-resize", this.setAttribute(w, "top")), p !== "" ? (this.rectangleBeforeResizing = this.getBoundingClientRect(), this.style.setProperty("--resize-cursor", p)) : (this.style.removeProperty("--resize-cursor"), this.removeAttribute(w)), this.toggleAttribute(oe, p !== "");
    }, this.floatingResizingMouseDownListener = (e) => {
      if (!this.hasAttribute(oe) || e.button !== 0)
        return;
      ...
      this.panelInfo?.floating && (this.floatingResizingStarted || (this.removeAttribute("resizing"), this.removeAttribute(oe), this.removeAttribute("dragging"), this.style.removeProperty("--resize-cursor"), this.removeAttribute(w)));
      ...
      const { width: t, height: i } = this.getBoundingClientRect(), { left: n, top: o, bottom: s, right: a } = I.anchor(this), p = window.getComputedStyle(this.container), f = Number.parseInt(p.borderTopWidth, 10), b = Number.parseInt(p.borderBottomWidth, 10);
      ...
      e.button === 0 && (c.bringToFront(this.panelInfo.tag), !this.hasAttribute(w) && (e.target instanceof HTMLButtonElement && e.target.getAttribute("part") === "title-button" ? this.startDraggingDebounce(e) : this.startDragging(e)));
    ...
    }, this.startDraggingDebounce = K(this.startDragging, 200), this.draggingEventListener = (e) => {
      const t = I.dragging(this, e);
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), we(this), this.panelInfo?.floating)
      ...
      this.panelInfo && (e.stopPropagation(), I.anchorLeftTop(this), c.updatePanel(this.panelInfo.tag, {
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            r.operationInProgress === pe.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
  ...
  setResizePosition(e, t, i) {
    const n = this.rectangleBeforeResizing, o = 0, s = window.innerWidth, a = 0, p = window.innerHeight, f = Math.max(o, Math.min(s, t)), b = Math.max(a, Math.min(p, i));
    if (e === "left")
  ...
  changeDockingPanel(e) {
    ...
    if (this.panelInfo?.panel !== t) {
      ...
      we(this), c.updatePanel(this.panelInfo.tag, { panel: t, panelOrder: i + 1 });
    }
...
const le = window.Vaadin.copilot.customComponentHandler;
if (!le)
...
g.on("undoRedo", (e) => {
  const i = { files: Vt(e), uiId: ot() }, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", o = e.detail.undo ? "undo" : "redo";
  st(o), Bt(pe.RedoUndo), ue(n, i, (s) => {
    s.data.performed || (F({
      type: q.INFORMATION,
...
function Vt(e) {
  ...
  const t = le.getActiveDrillDownContext();
  if (t) {
    const i = le.getCustomComponentInfo(t);
    if (i)
      return new Array(i.customComponentFilePath);
  }
  return at();
}
var Jt = Object.getOwnPropertyDescriptor, Ft = (e, t, i, n) => {
...
const ke = window?.Vaadin?.connectionState?.stateChangeListeners;
ke ? ke.add((e, t) => {
  e === "loading" && t === "connected" && r.active && fe();
...
g.on("copilot-early-project-state", (e) => {
  z.setSpringSecurityEnabled(e.detail.springSecurityEnabled), z.setSpringJpaDataEnabled(e.detail.springJpaDataEnabled), z.setSupportsHilla(e.detail.supportsHilla), z.setUrlPrefix(e.detail.urlPrefix), e.preventDefault();
});
...
const Yt = {
   ...
   */
  run(e) {
    de || (de = !0, queueMicrotask(() => Xt())), M.push(e);
    const t = Se;
    return Se += 1, t;
  },
  /**
...
const V = (e, t) => {
  ...
  for (const n of i) n._$AO?.(t, !1), V(n, t);
  return !0;
}, G = (e) => {
  let t, i;
  do {
...
function Wt(e) {
  this._$AN !== void 0 ? (G(this), this._$AM = e, Ne(this)) : this._$AM = e;
}
function Gt(e, t = !1, i = 0) {
  const n = this._$AH, o = this._$AN;
  if (o !== void 0 && o.size !== 0) if (t) if (Array.isArray(n)) for (let s = i; s < n.length; s++) V(n[s], !1), G(n[s]);
  else n != null && (V(n, !1), G(n));
  else V(this, e);
}
const Kt = (e) => {
  e.type == _e.CHILD && (e._$AP ??= Gt, e._$AQ ??= Wt);
};
class Zt extends pt {
  constructor() {
  ...
  _$AO(t, i = !0) {
    t !== this.isConnected && (this.isConnected = t, t ? this.reconnected?.() : this.disconnected?.()), i && (V(this, t), G(this));
  }
  setValue(t) {
...
class Qt extends Zt {
  ...
  /** @override */
  update(t, [i, n]) {
    return this.hasChanged(n) ? (this.host = t.options && t.options.host, this.element = t.element, this.renderer = i, this.previousValue === De ? this.addRenderer() : this.runRenderer(), this.previousValue = Array.isArray(n) ? [...n] : n, u) : u;
  }
  /** @override */
  reconnected() {
    this.addRenderer();
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const se = Symbol("contentUpdateDebouncer");
class ve extends Qt {
  /**
   ...
   */
  removeRenderer() {
    this.element[this.rendererProperty] = null, delete this.element[se];
  }
}
class ei extends ve {
  get rendererProperty() {
...
const Be = ge(ei), Ve = ge(ti), Je = ge(ii);
var ni = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, Fe = (e, t, i, n) => {
...
let ce = class extends he {
  ...
  firstUpdated(e) {
    super.firstUpdated(e), Q(this.renderRoot);
  }
  render() {
...
Fe([
  E()
], ce.prototype, "opened", 2);
ce = Fe([
  y("copilot-ai-usage-confirmation-dialog")
], ce);
var si = Object.defineProperty, ai = Object.getOwnPropertyDescriptor, L = (e, t, i, n) => {
...
let $ = class extends he {
  ...
  connectedCallback() {
    super.connectedCallback(), g.on("submit-exception-report-clicked", this.eventListener);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), g.off("submit-exception-report-clicked", this.eventListener);
  }
  firstUpdated(e) {
    super.firstUpdated(e), Q(this.renderRoot);
  }
  ...
  renderItemDescription(e) {
    return Object.keys(Ee).indexOf(e.name.toLowerCase()) !== -1 ? Ee[e.name.toLowerCase()] : null;
  }
  bodyLengthExceeds() {
...
`)}`;
  ...
  submitErrorToGithub() {
    ...
    n.length >= 7500 && (mt(i), n = encodeURIComponent("Please paste report here. It was automatically added to your clipboard."));
...
L([
  v()
], $.prototype, "exceptionReport", 2);
L([
  v()
], $.prototype, "dialogOpened", 2);
L([
  v()
], $.prototype, "visibleItemIndex", 2);
L([
  v()
], $.prototype, "versions", 2);
L([
  v()
], $.prototype, "selectedItems", 2);
L([
  v()
], $.prototype, "searchInputValue", 2);
$ = L([
...
g.on("copilot-java-after-update", (e) => {
  ...
  F({
    type: q.INFORMATION,
    message: `Java changes were hot deployed for ${gt(t)}`,
