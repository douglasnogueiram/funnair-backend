...
var zo = {};
function Kn() {
  return typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : zo;
}
var oi = Object.assign, Ut = Object.getOwnPropertyDescriptor, Z = Object.defineProperty, tn = Object.prototype, Bt = [];
Object.freeze(Bt);
var qn = {};
Object.freeze(qn);
var Lo = typeof Proxy < "u", Uo = /* @__PURE__ */ Object.toString();
function ai() {
  Lo || p(process.env.NODE_ENV !== "production" ? "`Proxy` objects are not available in the current environment. Please configure MobX to enable a fallback implementation.`" : "Proxy not available");
}
function tt(e) {
...
var ht = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : ci ? function(e) {
...
function Ot(e, t, n) {
  if (K(e, ie) || rn(e, ie, pe({}, e[ie])), process.env.NODE_ENV !== "production" && Ft(n) && !K(e[ie], t)) {
  ...
  Jo(e, n, t), Ft(n) || (e[ie][t] = n);
}
function Jo(e, t, n) {
  if (process.env.NODE_ENV !== "production" && !Ft(t) && K(e[ie], n)) {
...
function Ce(e, t, n) {
  return bt(e) ? e : Array.isArray(e) ? x.array(e, {
    name: n
    ...
    name: n
  }) : typeof e == "function" && !Fe(e) && !mt(e) ? si(e) ? He(e) : gt(n, e) : e;
}
function Zo(e, t, n) {
...
function Qo(e, t) {
  return process.env.NODE_ENV !== "production" && bt(e) && p("observable.struct should not be used with observable values"), Ji(e, t) ? t : e;
}
var ea = "override";
function Ft(e) {
...
function oa(e, t, n, r) {
  ...
  if (r === e.target_)
    return this.extend_(e, t, n, !1) === null ? 0 : 2;
  if ((i = this.options_) != null && i.bound && (!K(e.target_, t) || !mt(e.target_[t])) && this.extend_(e, t, n, !1) === null)
    return 0;
  if (mt(n.value))
    return 1;
...
function ua(e, t, n, r) {
  return fa(e, this, t, n), e.defineComputedProperty_(t, pe({}, this.options_, {
    get: n.get,
    set: n.set
  }), r);
}
function da(e, t) {
  ...
  return i(function() {
    var o = Ye(this)[m], a = pe({}, n.options_, {
      get: e,
      context: this
    });
...
function va(e, t, n, r) {
  var i, o;
  return ga(e, this, t, n), e.defineObservableProperty_(t, n.value, (i = (o = this.options_) == null ? void 0 : o.enhancer) != null ? i : Ce, r);
}
function ha(e, t) {
  if (process.env.NODE_ENV !== "production") {
    if (t.kind === "field")
  ...
  function a(s, l) {
    var c, u, d = Ye(s)[m], v = new xe(l, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : Ce, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
var Ea = "observable", Oa = "observable.ref", Aa = "observable.shallow", xa = "observable.struct", mi = {
  deep: !0,
  name: void 0,
...
var Dn = /* @__PURE__ */ sn(Ea), Sa = /* @__PURE__ */ sn(Oa, {
  enhancer: an
}), Na = /* @__PURE__ */ sn(Aa, {
  enhancer: Zo
}), Ca = /* @__PURE__ */ sn(xa, {
...
function $t(e) {
  return e.deep === !0 ? Ce : e.deep === !1 ? an : $a(e.defaultDecorator);
}
function Pa(e) {
  var t;
...
function _i(e, t, n) {
  ...
  return bt(e) ? e : P(e) ? x.object(e, t, n) : Array.isArray(e) ? x.array(e, t) : Ge(e) ? x.map(e, t) : re(e) ? x.set(e, t) : typeof e == "object" && e !== null ? e : x.box(e, t);
}
oi(_i, bi);
var Da = {
  box: function(t, n) {
  ...
  array: function(t, n) {
    var r = Pt(n);
    return (f.useProxies === !1 || r.proxy === !1 ? Ns : ms)(t, $t(r), r.name);
  },
  map: function(t, n) {
    var r = Pt(n);
  ...
  set: function(t, n) {
    var r = Pt(n);
    return new Hi(t, $t(r), r.name);
  },
  object: function(t, n, r) {
    return Ve(function() {
      return zi(f.useProxies === !1 || r?.proxy === !1 ? Ye({}, r) : vs({}, r), t, n);
    });
  },
  ref: /* @__PURE__ */ Q(Sa),
...
}, x = /* @__PURE__ */ oi(_i, Da), yi = "computed", ka = "computed.struct", kn = /* @__PURE__ */ Jn(yi), Ta = /* @__PURE__ */ Jn(ka, {
...
var lr, cr, Ht = 0, Ia = 1, Va = (lr = (cr = /* @__PURE__ */ Ut(function() {
...
function ja(e) {
  Ht !== e.actionId_ && p(30), Ht = e.parentActionId_, e.error_ !== void 0 && (f.suppressReactionErrors = !0), un(e.prevAllowStateChanges_), dt(e.prevAllowStateReads_), L(), e.runAsAction_ && ae(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && I({
...
var za = "create", xe = /* @__PURE__ */ function(e) {
  ...
  return n.dehanceValue = function(i) {
    ...
    var o = this.value_;
    this.value_ = i, this.reportChanged(), q(this) && W(this, {
      type: H,
      object: this,
      newValue: i,
      oldValue: o
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.observers_.size === 0 && !this.keepAlive_)
      Tn(this) && (this.warnAboutUntrackedRead_(), z(), this.value_ = this.computeValue_(!1), L());
    else if (Ni(this), Tn(this)) {
    ...
    this.keepAlive_ || (In(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== U.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
...
B.diffValueMask_ = 16;
var dn = /* @__PURE__ */ Te("ComputedValue", B), _;
(function(e) {
...
function Tn(e) {
  switch (e.dependenciesState_) {
    ...
    case _.POSSIBLY_STALE_: {
      for (var t = Xn(!0), n = Ie(), r = e.observing_, i = r.length, o = 0; o < i; o++) {
        var a = r[o];
        if (dn(a)) {
...
function Ei(e, t, n) {
  ...
  return f.inBatch--, f.trackingDerivation = i, Ba(e), Ua(e), dt(r), o;
}
function Ua(e) {
...
function Ba(e) {
  ...
  for (n.length = i, e.newObserving_ = null, o = t.length; o--; ) {
    var l = t[o];
    l.diffValue === 0 && xi(l, e), l.diffValue = 0;
  }
  for (; i--; ) {
    var c = n[i];
...
var ee = /* @__PURE__ */ function() {
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.isDisposed || (this.isDisposed = !0, this.isRunning || (z(), In(this), L()));
...
function I(e) {
  process.env.NODE_ENV !== "production" && $e(e ? pe({}, e, {
    type: "report-end",
    spyReportEnd: !0
  }) : Ja);
}
...
var Yn = "action", Ya = "action.bound", ki = "autoAction", Za = "autoAction.bound", Ti = "<unnamed action>", Vn = /* @__PURE__ */ xt(Yn), Qa = /* @__PURE__ */ xt(Ya, {
  bound: !0
}), Rn = /* @__PURE__ */ xt(ki, {
  autoAction: !0
}), es = /* @__PURE__ */ xt(Za, {
...
var Oe = /* @__PURE__ */ Ii(!1);
Object.assign(Oe, Vn);
var gt = /* @__PURE__ */ Ii(!0);
Object.assign(gt, Rn);
Oe.bound = /* @__PURE__ */ Q(Qa);
gt.bound = /* @__PURE__ */ Q(es);
function lu(e) {
  return wi(e.name || Ti, !1, e, this, void 0);
}
function Fe(e) {
...
function Vi(e, t) {
  var n, r, i, o;
  t === void 0 && (t = qn), process.env.NODE_ENV !== "production" && (A(e) || p("Autorun expects a function as first argument"), Fe(e) && p("Autorun does not accept actions since actions are untrackable"));
...
function Zn(e, t, n) {
  var r, i, o;
  n === void 0 && (n = qn), process.env.NODE_ENV !== "production" && ((!A(e) || !A(t)) && p("First and second argument to reaction should be functions"), P(n) || p("Third argument of reactions should be an object"));
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + F() : "Reaction", s = Oe(a, n.onError ? ns(n.onError, t) : t), l = !n.scheduler && !n.delay, c = Ri(n), u = !0, d = !1, v, h = n.compareStructural ? Be.structural : n.equals || Be.default, b = new ee(a, function() {
    u || l ? E() : d || (d = !0, c(E));
  ...
  function E() {
    if (d = !1, !b.isDisposed) {
      var S = !1, J = v;
      b.track(function() {
        var je = Ma(!1, function() {
          return e(b);
        });
        S = u || !h(v, je), v = je;
      }), (u && n.fireImmediately || !u && S) && s(v, J, b), u = !1;
    }
  }
...
function Li(e) {
  ...
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = ss(e.observing_).map(Li)), t;
}
function ss(e) {
...
var _n = /* @__PURE__ */ vi("flow"), cs = /* @__PURE__ */ vi("flow.bound", {
  bound: !0
  ...
  var r = t, i = r.name || "<unnamed flow>", o = function() {
    var s = this, l = arguments, c = ++ls, u = Oe(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0, h = new Promise(function(b, E) {
      var S = 0;
      d = E;
      function J($) {
        v = void 0;
      ...
      function et($) {
        ...
        return $.done ? b($.value) : (v = Promise.resolve($.value), v.then(J, je));
      }
      J(void 0);
    });
...
function bt(e) {
  return process.env.NODE_ENV !== "production" && arguments.length !== 1 && p("isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property"), us(e);
}
function ds() {
  if (process.env.NODE_ENV !== "production") {
...
var ps = {
  ...
  set: function(t, n, r) {
    var i;
    return Ne(n) ? (process.env.NODE_ENV !== "production" && !_e(t).values_.has(n) && tt("add a new observable property through direct assignment. Use 'set' from 'mobx' instead."), (i = _e(t).set_(n, r, !0)) != null ? i : !0) : !1;
  },
  deleteProperty: function(t, n) {
    var r;
    return process.env.NODE_ENV !== "production" && tt("delete properties from an observable object. Use 'remove' from 'mobx' instead."), Ne(n) ? (r = _e(t).delete_(n, !0)) != null ? r : !0 : !1;
  },
...
function vs(e, t) {
  var n, r;
  return ai(), e = Ye(e, t), (r = (n = e[m]).proxy_) != null ? r : n.proxy_ = new Proxy(e, ps);
}
function j(e) {
...
function Xe(e, t, n) {
  return process.env.NODE_ENV !== "production" && (!P(e) && !P(Object.getPrototypeOf(e)) && p("'makeAutoObservable' can only be used for classes that don't have a superclass"), Ze(e) && p("makeAutoObservable can only be used on objects not already made observable")), P(e) ? zi(e, e, t, n) : (Ve(function() {
    var r = Ye(e, n)[m];
    if (!e[yn]) {
...
var pr = "splice", H = "update", hs = 1e4, gs = {
  get: function(t, n) {
    var r = t[m];
    return n === m ? r : n === "length" ? r.getArrayLength_() : typeof n == "string" && !isNaN(n) ? r.get_(parseInt(n)) : K(Wt, n) ? Wt[n] : t[n];
  },
  set: function(t, n, r) {
    var i = t[m];
  ...
  return t.dehanceValue_ = function(r) {
    ...
    r !== this.lastKnownLength_ && p(16), this.lastKnownLength_ += i, this.legacyMode_ && i > 0 && Wi(r + i + 1);
    ...
    var a = !this.owned_ && C(), s = q(this), l = s || a ? {
      observableKind: "array",
      object: this.proxy_,
      type: H,
      debugObjectName: this.atom_.name_,
...
function ms(e, t, n, r) {
  return n === void 0 && (n = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), r === void 0 && (r = !1), ai(), Ve(function() {
...
var bs = /* @__PURE__ */ Te("ObservableArrayAdministration", Qn);
function fn(e) {
  return nn(e) && bs(e[m]);
}
var _s = {}, de = "add", Gt = "delete", Fi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ce), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + F() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[m] = _s, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = r, this.name_ = i, A(Map) || p(18), Ve(function() {
  ...
  return t.has_ = function(r) {
    ...
    if (!o) {
      var a = o = new xe(this.has_(r), an, process.env.NODE_ENV !== "production" ? this.name_ + "." + Pn(r) + "?" : "ObservableMap.key?", !1);
    ...
    Y(this.keysAtom_), oe(function() {
      var c, u = new xe(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + Pn(r) : "ObservableMap.key", !1);
    ...
    return me(r) && (r = new Map(r)), oe(function() {
      P(r) ? Fo(r).forEach(function(o) {
        ...
        var a = o[0], s = o[1];
        return i.set(a, s);
      }) : Ge(r) ? (Bo(r) || p(19, r), r.forEach(function(o, a) {
        return i.set(a, o);
      })) : r != null && p(20, r);
    }), this;
  }, t.clear = function() {
    ...
    var i = this;
    return oe(function() {
      for (var o = ys(r), a = /* @__PURE__ */ new Map(), s = !1, l = Ue(i.data_.keys()), c; !(c = l()).done; ) {
        var u = c.value;
        if (!o.has(u)) {
          var d = i.delete(u);
          if (d)
      ...
      for (var h = Ue(o.entries()), b; !(b = h()).done; ) {
        var E = b.value, S = E[0], J = E[1], je = i.data_.has(S);
        if (i.set(S, J), i.data_.has(S)) {
          var et = i.data_.get(S);
          a.set(S, et), je || (s = !0);
        }
      }
      if (!s)
    ...
    return process.env.NODE_ENV !== "production" && i === !0 && p("`observe` doesn't support fireImmediately=true in combination with maps."), Nt(this, r);
  }, t.intercept_ = function(r) {
    return St(this, r);
  }, Je(e, [{
    key: "size",
...
}(), me = /* @__PURE__ */ Te("ObservableMap", Fi);
function vr(e) {
...
var ws = {}, Hi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ce), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + F() : "ObservableSet"), this.name_ = void 0, this[m] = ws, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, A(Set) || p(22), this.enhancer_ = function(a, s) {
      return r(a, s, i);
    }, Ve(function() {
  ...
  return t.dehanceValue_ = function(r) {
    ...
    if (!this.has(r)) {
      ...
      var a = process.env.NODE_ENV !== "production" && C(), s = q(this), l = s || a ? {
        observableKind: "set",
        debugObjectName: this.name_,
        type: de,
        object: this,
    ...
    return process.env.NODE_ENV !== "production" && i === !0 && p("`observe` doesn't support fireImmediately=true in combination with sets."), Nt(this, r);
  }, t.intercept_ = function(r) {
    return St(this, r);
  }, t.toJSON = function() {
    return Array.from(this);
...
var gr = /* @__PURE__ */ Object.create(null), mr = "remove", jn = /* @__PURE__ */ function() {
  ...
  return t.getObservablePropValue_ = function(r) {
    ...
    if (i = o.prepareNewValue_(i), i !== f.UNCHANGED) {
      var s = q(this), l = process.env.NODE_ENV !== "production" && C(), c = s || l ? {
        type: H,
    ...
    return f.trackingDerivation && !K(this.target_, r) && this.has_(r), this.target_[r];
    ...
    return i || (i = new xe(r in this.target_, an, process.env.NODE_ENV !== "production" ? this.name_ + "." + Pn(r) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(r, i)), i.get();
    ...
    if (i === void 0 && (i = !1), Y(this.keysAtom_), !K(this.target_, r))
      return !0;
    if (j(this)) {
      var o = M(this, {
        object: this.proxy_ || this.target_,
    ...
    try {
      var a;
      z();
      var s = q(this), l = process.env.NODE_ENV !== "production" && C(), c = this.values_.get(r), u = void 0;
      if (!c && (s || l)) {
        var d;
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[r], c && (this.values_.delete(r), c instanceof xe && (u = c.value_), Ci(c)), this.keysAtom_.reportChanged(), (a = this.pendingKeys_) == null || (a = a.get(r)) == null || a.set(r in this.target_), s || l) {
        var v = {
          type: mr,
          observableKind: "object",
          object: this.proxy_ || this.target_,
    ...
    return process.env.NODE_ENV !== "production" && i === !0 && p("`observe` doesn't support the fire immediately property for observable objects."), Nt(this, r);
  }, t.intercept_ = function(r) {
    return St(this, r);
  }, t.notifyPropertyAddition_ = function(r, i) {
    var o, a = q(this), s = process.env.NODE_ENV !== "production" && C();
    if (a || s) {
      var l = a || s ? {
        type: de,
        observableKind: "object",
...
function Ye(e, t) {
  var n;
  if (process.env.NODE_ENV !== "production" && t && Ze(e) && p("Options can't be provided for already observable objects."), K(e, m))
    return process.env.NODE_ENV !== "production" && !(Gi(e) instanceof jn) && p("Cannot convert '" + Jt(e) + `' into observable object:
...
Extending builtins is not supported.`), e;
  ...
  var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (P(e) ? "ObservableObject" : e.constructor.name) + "@" + F() : "ObservableObject", i = new jn(e, /* @__PURE__ */ new Map(), String(r), Pa(t));
  return rn(e, m, i), e;
}
var Es = /* @__PURE__ */ Te("ObservableObjectAdministration", jn);
function br(e) {
  return gr[e] || (gr[e] = {
    get: function() {
...
function yr(e, t, n) {
  if (process.env.NODE_ENV !== "production" && !Xi(t) && p("Cannot annotate '" + e.name_ + "." + n.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Ft(t) && K(e.appliedAnnotations_, n)) {
...
xs(Ki, Array.prototype);
var er = /* @__PURE__ */ function(e) {
  function t(r, i, o, a) {
    var s;
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), a === void 0 && (a = !1), s = e.call(this) || this, Ve(function() {
...
function Gi(e, t) {
  if (e || p(29), Gn(e) || dn(e) || qt(e) || me(e) || X(e))
    return e;
  if (e[m])
    return e[m];
  p(24, e);
...
var Or, Cs = ((Or = Kn().Iterator) == null ? void 0 : Or.prototype) || {};
function tr(e) {
...
const $s = Symbol.for("react.portal"), Ds = Symbol.for("react.fragment"), ks = Symbol.for("react.strict_mode"), Ts = Symbol.for("react.profiler"), Is = Symbol.for("react.provider"), Vs = Symbol.for("react.context"), Yi = Symbol.for("react.forward_ref"), Rs = Symbol.for("react.suspense"), js = Symbol.for("react.suspense_list"), Ms = Symbol.for("react.memo"), zs = Symbol.for("react.lazy");
function Ls(e, t, n) {
...
function ct(e) {
  const t = e.type;
  return t?.$$typeof === Yi && !t.displayName && e.child ? ct(e.child) : Xt(e.type) ?? Xt(e.elementType) ?? "???";
}
function qs() {
  const e = Array.from(document.querySelectorAll("body > *")).flatMap((n) => n[Ks()]).find((n) => n), t = De(e);
  return De(t?.child);
}
function Ws(e) {
  const t = [];
...
function Xs(e) {
  return typeof e.type != "function" || Qi(e) ? !1 : !!(Yt(e) || Bs(e));
}
function Qi(e) {
  if (!e)
    return !1;
...
const pn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), ve = "copilot-", Ys = "24.8.0.alpha7", uu = "attention-required", du = "https://plugins.jetbrains.com/plugin/23758-vaadin", fu = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function pu(e) {
...
function vn(e) {
  Promise.resolve().then(() => rc).then(({ showNotification: t }) => {
    t(e);
  });
}
function rl() {
...
const yu = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, sl = (e) => {
  const t = [];
  let n = cl(e);
  for (; n; )
...
window.Vaadin.copilot._machineState = new gl();
window.Vaadin.copilot._storedProjectState = new yl();
window.Vaadin.copilot._previewState = new ml();
window.Vaadin.copilot._sectionPanelUiState = new bl();
window.Vaadin.copilot._earlyProjectState = new _l();
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Mt = globalThis, nr = Mt.ShadowRoot && (Mt.ShadyCSS === void 0 || Mt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, rr = Symbol(), kr = /* @__PURE__ */ new WeakMap();
let uo = class {
  constructor(t, n, r) {
...
}, Tr = nr ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let n = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Al, defineProperty: xl, getOwnPropertyDescriptor: Sl, getOwnPropertyNames: Nl, getOwnPropertySymbols: Cl, getPrototypeOf: Pl } = Object, hn = globalThis, Ir = hn.trustedTypes, $l = Ir ? Ir.emptyScript : "", Dl = hn.reactiveElementPolyfillSupport, ft = (e, t) => e, Un = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? $l : null;
      break;
  ...
  return n;
} }, fo = (e, t) => !Al(e, t), Vr = { attribute: !0, type: String, converter: Un, reflect: !1, hasChanged: fo };
...
let ze = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ft("properties"))) {
      const n = this.properties, r = [...Nl(n), ...Cl(n)];
...
ze.elementStyles = [], ze.shadowRootOptions = { mode: "open" }, ze[ft("elementProperties")] = /* @__PURE__ */ new Map(), ze[ft("finalized")] = /* @__PURE__ */ new Map(), Dl?.({ ReactiveElement: ze }), (hn.reactiveElementVersions ??= []).push("2.0.4");
const Me = Symbol("LitMobxRenderReaction"), Rr = Symbol("LitMobxRequestUpdate");
function kl(e, t) {
  var n, r;
  return r = class extends e {
    ...
    connectedCallback() {
      ...
      this[Me] = new t(`${o}.update()`, this[Rr]), this.hasUpdated && this.requestUpdate();
    }
    disconnectedCallback() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ir = globalThis, en = ir.trustedTypes, jr = en ? en.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, po = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, vo = "?" + ue, Il = `<${vo}>`, ke = document, yt = () => ke.createComment(""), wt = (e) => e === null || typeof e != "object" && typeof e != "function", or = Array.isArray, Vl = (e) => or(e) || typeof e?.[Symbol.iterator] == "function", An = `[ 	
\f\r]`, rt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Mr = /-->/g, zr = />/g, ye = RegExp(`>|${An}(?:([^\\s"'>=/]+)(${An}*=${An}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Lr = /'/g, Ur = /"/g, ho = /^(?:script|style|textarea|title)$/i, go = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), Se = go(1), Su = go(2), he = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), Br = /* @__PURE__ */ new WeakMap(), Ae = ke.createTreeWalker(ke, 129);
function mo(e, t) {
...
const Rl = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    const l = e[s];
    let c, u, d = -1, v = 0;
    for (; v < l.length && (a.lastIndex = v, u = a.exec(l), u !== null); ) v = a.lastIndex, a === rt ? u[1] === "!--" ? a = Mr : u[1] !== void 0 ? a = zr : u[2] !== void 0 ? (ho.test(u[2]) && (i = RegExp("</" + u[2], "g")), a = ye) : u[3] !== void 0 && (a = ye) : a === ye ? u[0] === ">" ? (a = i ?? rt, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, c = u[1], a = u[3] === void 0 ? ye : u[3] === '"' ? Ur : Lr) : a === Ur || a === Lr ? a = ye : a === Mr || a === zr ? a = rt : (a = ye, i = void 0);
    const h = a === ye && e[s + 1].startsWith("/>") ? " " : "";
    o += a === rt ? l + Il : d >= 0 ? (r.push(c), l.slice(0, d) + po + l.slice(d) + ue + h) : l + ue + (d === -2 ? s : h);
  }
...
class Et {
  constructor({ strings: t, _$litType$: n }, r) {
    ...
    this.parts = [];
    let o = 0, a = 0;
    const s = t.length - 1, l = this.parts, [c, u] = Rl(t, n);
    ...
    for (; (i = Ae.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(po)) {
          const v = u[a++], h = i.getAttribute(d).split(ue), b = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: o, name: b[2], strings: h, ctor: b[1] === "." ? Ml : b[1] === "?" ? zl : b[1] === "@" ? Ll : gn }), i.removeAttribute(d);
        ...
        if (ho.test(i.tagName)) {
          ...
          if (v > 0) {
            ...
            for (let h = 0; h < v; h++) i.append(d[h], yt()), Ae.nextNode(), l.push({ type: 2, index: ++o });
            i.append(d[v], yt());
          }
        }
...
let jl = class {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new Qe(o, o.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (c = new Ul(o, this, t)), this._$AV.push(c), l = r[++s];
      }
      a !== l?.index && (o = Ae.nextNode(), a++);
    }
    return Ae.currentNode = ke, i;
  }
  p(t) {
    let n = 0;
...
class Qe {
  ...
  _$AI(t, n = this) {
    t = We(this, t, n), wt(t) ? t === O || t == null || t === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : t !== this._$AH && t !== he && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Vl(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== O && wt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(ke.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: n, _$litType$: r } = t, i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Et.createElement(mo(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === i) this._$AH.p(n);
    else {
      const o = new jl(i, this), a = o.u(this.options);
...
class gn {
  ...
  _$AI(t, n = this, r, i) {
    ...
    let a = !1;
    if (o === void 0) t = We(this, t, n, 0), a = !wt(t) || t !== this._$AH && t !== he, a && (this._$AH = t);
    else {
      const s = t;
      let l, c;
      for (t = o[0], l = 0; l < o.length - 1; l++) c = We(this, s[r + l], n, l), c === he && (c = this._$AH[l]), a ||= !wt(c) || c !== this._$AH[l], c === O ? t = O : t !== O && (t += (c ?? "") + o[l + 1]), this._$AH[l] = c;
    }
    a && !i && this.j(t);
  }
  j(t) {
...
class Ll extends gn {
  ...
  _$AI(t, n = this) {
    if ((t = We(this, t, n, 0) ?? O) === he) return;
...
const Bl = { I: Qe }, Fl = ir.litHtmlPolyfillSupport;
Fl?.(Et, Qe), (ir.litHtmlVersions ??= []).push("3.2.1");
const Hl = (e, t, n) => {
...
let pt = class extends ze {
  ...
  update(t) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Hl(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
function Gl() {
  Ee.push(import("./copilot-log-plugin-vTU3MNPZ.js")), Ee.push(import("./copilot-info-plugin-0leedchh.js")), Ee.push(import("./copilot-features-plugin-Beq27tDl.js")), Ee.push(import("./copilot-feedback-plugin-BH9P8_-7.js")), Ee.push(import("./copilot-shortcuts-plugin-BtFgatsQ.js"));
}
function Jl() {
  {
    const e = `https://cdn.vaadin.com/copilot/${Ys}/copilot-plugins.js`;
    import(
      /* @vite-ignore */
      e
    ).catch((t) => {
...
const It = new Yl(), y = window.Vaadin.copilot.eventbus;
if (!y)
  throw new Error("Tried to access copilot eventbus before it was initialized.");
const ot = window.Vaadin.copilot.overlayManager, $u = {
...
const Zl = _o(Bn), Ct = window.Vaadin.copilot._machineState;
if (!Ct)
  throw new Error("Trying to use stored machine state before it was initialized");
const Ql = 5e3;
let Kr = 1;
function wo(e) {
  g.notifications.includes(e) && (e.dontShowAgain && e.dismissId && ec(e.dismissId), g.removeNotification(e), y.emit("notification-dismissed", e));
}
function Eo(e) {
  return Ct.getDismissedNotifications().includes(e);
}
function ec(e) {
  Eo(e) || Ct.addDismissedNotification(e);
}
function tc(e) {
...
function nc(e) {
  ...
  g.setNotifications([...g.notifications, n]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    wo(n);
  }, e.delay ?? Ql), y.emit("notification-shown", e);
}
...
function oc() {
  pn(`${ve}plugin-restart-application`, {}, () => {
  }).catch((e) => {
...
const ac = async () => to(() => g.userInfo), Du = async () => (await ac()).vaadiner;
function sc() {
  const e = g.userInfo;
...
const lc = (e) => {
...
}, cc = (e, t) => e.error ? (uc(e.error, t), !0) : !1, qr = (e, t, n) => {
  vn({
    type: Re.ERROR,
    message: e,
    details: no(
      Se`<vaadin-details summary="Details" style="color: var(--dev-tools-text-color)"
          ><div>
            <code class="codeblock"><copilot-copy></copilot-copy>${Zl(t)}</code>
          </div>
        </vaadin-details>
        ${n !== void 0 ? Se`
              <vaadin-button
        ...
        n && y.emit("submit-exception-report-clicked", n);
                ...
                >Report this issue</vaadin-button
              >
            ` : O} `
    ),
    delay: 3e4
  ...
  i && o ? fc(
    ...
    t,
    n
  ) : qr(e, t), sc() && y.emit("system-info-with-callback", {
...
function dc(e, t) {
  ...
  xo(e, t.message, t.stack ?? "", void 0, n);
}
function xn(e) {
...
${n}` : "")
  ...
  xn(t) && t.suggestRestart && ic() && (r.details = no(
    Se`${e}<br />${n}
        <button
          style="align-self:start;padding:0"
          @click=${(o) => {
      const a = o.target;
      a.disabled = !0, a.innerText = "Restarting...", oc();
    }}>
          Restart now
        </button>`
  ), r.delay = 3e4), vn(r);
...
function So() {
  ...
  Array.isArray(t) && Fn.push(...t), No((n) => Fn.push(n));
}
  ...
  window.Vaadin.ConsoleErrors = {
    push: (n) => {
      n[0].type !== void 0 && n[0].message !== void 0 ? e({
        ...
        details: n[0].details,
        link: n[0].link
      }) : e({ type: Re.ERROR, message: n.map((r) => pc(r)).join(" "), internal: !1 }), t.push(n);
    }
  };
}
function pc(e) {
...
const hc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  handleBrowserOperationError: dc,
  handleCopilotError: le,
  handleErrorDuringOperation: lc,
...
}, gc = async () => pn(`${ve}get-user-info`, {}, (e) => (delete e.data.reqId, e.data));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Po = Symbol.for(""), mc = (e) => {
  if (e?.r === Po) return e?._$litStatic$;
}, $o = (e) => ({ _$litStatic$: e, r: Po }), Gr = /* @__PURE__ */ new Map(), bc = (e) => (t, ...n) => {
  const r = n.length;
  let i, o;
  const a = [], s = [];
  let l, c = 0, u = !1;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: _c } = Bl, ku = (e) => e.strings === void 0, Jr = () => document.createComment(""), at = (e, t, n) => {
  const r = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
  if (n === void 0) {
    const o = r.insertBefore(Jr(), i), a = r.insertBefore(Jr(), i);
  ...
  return n;
}, we = (e, t, n = e) => (e._$AI(t, n), e), yc = {}, wc = (e, t = yc) => e._$AH = t, Ec = (e) => e._$AH, Sn = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const Xr = (e, t, n) => {
  ...
  update(e, [t, n, r]) {
    ...
    else if (s[v] === a[h]) l[h] = we(i[v], o[h]), at(e, i[d], i[v]), v--, h++;
    else if (c === void 0 && (c = Xr(a, h, b), u = Xr(s, d, v)), c.has(s[d])) if (c.has(s[v])) {
      const E = u.get(a[h]), S = E !== void 0 ? i[E] : null;
      if (S === null) {
        const J = at(e, i[d]);
        we(J, o[h]), l[h] = J;
      } else l[h] = we(S, o[h]), at(e, i[d], S), i[E] = null;
      h++;
    } else Sn(i[v]), v--;
    else Sn(i[d]), d++;
    for (; h <= b; ) {
    ...
    return this.ut = a, wc(e, l), he;
  }
}), zt = /* @__PURE__ */ new Map(), Oc = (e) => {
...
const Cc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Yr = { randomUUID: Cc };
function ko(e, t, n) {
  if (Yr.randomUUID && !e)
...
const Qr = new qc(), Wc = "copilot-development-setup-user-guide";
function Mu() {
  _t("use-dev-workflow-guide"), se.updatePanel(Wc, { floating: !0 });
}
function Vo() {
  const e = g.jdkInfo;
...
class Xc {
  ...
  includeReactNode(t) {
    return ct(t) === "PreconfiguredAuthProvider" || ct(t) === "RouterProvider" ? !1 : Sr(t) || Xs(t);
  }
  async includeFlowNode(t) {
    return el(t) || En(t)?.hiddenByServer ? !1 : this.isInitializedInProjectSources(t);
  }
  async isInitializedInProjectSources(t) {
    ...
    if (!this.flowNodesInSource[i]) {
      const o = await pn("copilot-get-component-source-info", { uiId: i }, (a) => a.data);
  ...
  async addToTree(t, n) {
    ...
    if (n)
      ...
      if (!o)
        return !(t instanceof Element) && Qi(t) ? (Oo({
          type: Re.WARNING,
  ...
  generateNodeFromFiber(t, n) {
    const r = Sr(t) ? Qt(t) : void 0, i = n?.children.length ?? 0;
    return {
      node: t,
      parent: n,
      element: r,
  ...
  generateNodeFromFlow(t, n) {
    ...
    return {
      ...
      isReactComponent: !1,
      get name() {
        return Zs(r) ?? Cr(r.element.localName);
      },
      get identifier() {
        return Pr(t);
      },
...
const ri = (e) => {
  ...
  let i = !0, o = !1;
  ni(e) ? i = !1 : e.key === "Escape" ? g.loginCheckActive ? g.setLoginCheckActive(!1) : y.emit("close-drawers", {}) : ru(e) ? (y.emit("delete-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "d" ? (y.emit("duplicate-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "b" ? (y.emit("show-selected-in-ide", { attach: e.shiftKey }), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "z" && nu() ? (y.emit("undoRedo", { undo: !e.shiftKey }), o = !0) : ni(e) || y.emit("keyboard-event", { event: e }), i && e.stopPropagation(), o && e.preventDefault();
}, ru = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey, ne = eu(), Rt = "⇧", Uu = {
...
var iu = Object.getOwnPropertyDescriptor, ou = (e, t, n, r) => {
  for (var i = r > 1 ? void 0 : r ? iu(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = a(i) || i);
  return i;
};
let ii = class extends Wl {
  constructor() {
    ...
    }, this.operationInProgressCursorUpdateDebounceFunc = Kc(this.toggleOperationInProgressAttr, 500), this.overlayOutsideClickListener = (e) => {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-B8jvxg6a.js"), await import("./copilot-init-step2-BfMiLaJV.js"), ol(), Gl(), this.tabIndex = 0, It.hostConnectedCallback(), window.addEventListener("keydown", Hn), this.addEventListener("keydown", ri), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    ), So(), this.initialized = !0, Jc();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    It.activate(), Qr.copilotActivated(), Xl(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.addEventListener("mouseover", this.mouseOverListener), ot.onCopilotActivation(), await Yc(), Ao.loadPreviewConfiguration(), this.active = !0;
  }
  /**
   * Called when Copilot is deactivated. Good place to remove listeners etc.
   */
  deactivate() {
    this.closeDrawers(), It.deactivate(), Qr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.removeEventListener("mouseover", this.mouseOverListener), ot.onCopilotDeactivation(), this.active = !1;
  }
  disconnectedCallback() {
    super.disconnectedCallback(), It.hostDisconnectedCallback(), window.removeEventListener("keydown", Hn), this.removeEventListener("keydown", ri), y.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), ot.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
  ...
  renderDrawer(e) {
    return Se` <copilot-drawer-panel no-transition position=${e}>
      ${Oc(e)}
